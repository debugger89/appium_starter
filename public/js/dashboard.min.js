...
function SubmitNodeFormData($scope, $http) {
    console.log("In the submit dataXXX");
    
    $scope.submitData = submitData;
    
    function submitData(os, AppType, device, timeout){
        ...
        $http.post("/execute_shell", config)
...
angular.module("RDash")
    .controller("SubmitNodeFormData", ['$scope', '$http', SubmitNodeFormData]);